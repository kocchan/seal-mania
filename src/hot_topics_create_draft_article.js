...
入荷・抽選情報 (今月の新作, 抽選・予約情報, オンライン通販)
店舗攻略情報 (ドンキ, LOFT, ハンズ, コンビニ, ヴィレッジヴァンガード, TSUTAYA, その他)
キャラクターシール (ディズニー, サンリオ, たまごっち, しずくちゃん, ちいかわ, その他)
一般ガイド
目撃情報まとめ
...
[
  {
    ...
    "categories": ["都道府県別", "関東", "東京", "店舗攻略情報", "ドンキ"], // 必ず上記で提示したカテゴリ名の配列にすること（ID：数字で記載しないで）
